...
import syDialogNotice from '@/components/syDialogNotice.vue'
import syIframe from '@/components/syIframe.vue'
import syProgressbar.vue from '@/components/syProgressbar.vue.vue'
...
componentsArr.push(syProgressbar.vue) //吧要注册的组件push进去
